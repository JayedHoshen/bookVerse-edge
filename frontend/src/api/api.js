...
export const fetchMyReadingProgress = async () => {
  const response = await api.get("/reading-progress");
  return response.data;
};

export const fetchReadingProgressById = async (progressId) => {
  const response = await api.get(`/reading-progress/${progressId}`);
  return response.data;
};

export const updateReadingProgress = async (progressData) => {
  const response = await api.post("/reading-progress", progressData);
  return response.data;
};

export const deleteReadingProgress = async (progressId) => {
  const response = await api.delete(`/reading-progress/${progressId}`);
  return response.data;
};
