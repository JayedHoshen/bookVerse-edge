...
export default function Cart() {
  ...
  const applyPromoCode = () => {
    ...
    if (validCodes[codeUpper]) {
      ...
      alert(
        "❌ Invalid promo code. Try: GLOW15, RITUAL20, WELCOME10, or SELFCARE",
      );
      setOrderMessage("");
    }
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-8">
          <div className="flex-1 text-center sm:text-left">
            <h1 className="text-3xl md:text-4xl font-semibold text-gray-900">
              Your Cart
              <span className="text-lg ml-3 text-gray-500">
              ...
              {isEmpty ? (
                ...
                <div className="space-y-6 md:space-y-8">
                  {cartItems.map((item) => (
                    <div
                      key={item.productId}
                      className="flex flex-col sm:flex-row gap-4 sm:gap-6 border-b border-gray-100 pb-6 last:border-none last:pb-0 bg-gray-100 p-4 rounded-2xl items-center shadow hover:shadow-xl transition-shadow"
                    >
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        ...
                        <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="flex items-center border border-gray-200 rounded-2xl mx-auto sm:mx-0">
                            ...
                            <span className="px-6 font-medium min-w-10">
                              {item.quantity}
                            </span>
                            <button
                              onClick={() =>
