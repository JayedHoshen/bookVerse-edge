        ...
        <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-16 py-12 md:py-16">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 mb-20">
            ...
            <div className="flex-1 anim-2">
              <p className="uppercase tracking-widest text-xs text-[#9e8a85]">
                {product.category}
              </p>
              <h1 className="text-4xl md:text-5xl font-serif leading-tight mt-2 mb-4">
                {product.name}
              </h1>
              ...
              <div className="flex items-center gap-4 mb-8">
                <div className="flex border border-[#d4c4be] rounded-full overflow-hidden">
                  ...
                  <span className="w-12 flex items-center justify-center font-medium text-lg">
                    {qty}
                  </span>
                  <button
                ...
                <button
                  ...
                  style={{
                    background: added
                      ? "#4a7a4a"
                      : "linear-gradient(135deg, #7a5c56, #5e4540)",
                  }}
                >
              ...
              <p className="text-xs text-[#9e8a85]">
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="anim-3">
              <h2 className="text-3xl font-serif mb-8 text-[#2e2420]">
                Key Actives
              </h2>
                ...
                {keyActives.length > 0 ? (
                  keyActives.map((active, i) => (
                    <div key={i} className="flex gap-5">
                      ...
                      <div>
                        <h4 className="font-medium text-lg mb-1.5">
                          {active.name}
                        </h4>
                        <p className="text-sm text-[#7a6560] leading-relaxed">
                          {active.desc}
                        </p>
                      </div>
                    </div>
