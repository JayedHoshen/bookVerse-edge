        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Review and manage recent purchase rituals from your community.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <div className="bg-white rounded-3xl p-6">
              ...
              <p className="text-4xl font-semibold mt-3">
                {statsLoading ? "..." : orderStats?.data?.deliveredOrders || 0}
              </p>
              <p className="text-gray-500 text-sm mt-1">
                92.6% fulfillment rate
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6">
              ...
              <p className="text-4xl font-semibold mt-3">
                ...
                {statsLoading
                  ? "..."
                  : (orderStats?.data?.totalRevenue || 0).toLocaleString()}
              </p>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="flex items-center justify-between border-b p-6">
              <div className="flex gap-2">
                {["All Orders", "Pending", "Shipped", "Delivered"].map(
                  (tab) => (
                    <button
                      key={tab}
            ...
            <div className="px-6 py-5 flex items-center justify-between border-t">
              <p className="text-sm text-gray-500">
                Showing 1-{Math.min(filteredOrders.length, 10)} of{" "}
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-2 bg-rose-50 text-rose-700 rounded-xl font-medium">
                  1
                </button>
                <button className="px-4 py-2 hover:bg-gray-100 rounded-xl">
                  2
                </button>
                <button className="px-4 py-2 hover:bg-gray-100 rounded-xl">
                  3
          ...
          {/* Footer */}
          <div className="mt-12 text-center text-xs text-gray-400 flex flex-col lg:flex-row gap-4 lg:justify-between">
            <p>© 2026 BookVerse. Your library, your world.</p>
